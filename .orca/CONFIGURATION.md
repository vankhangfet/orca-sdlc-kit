...
- `<worktree>/<artifactsDir>/<file>.md.js` — one JSONP snapshot per step artifact (e.g. `PLAN.md.js`), written at run start for files that already exist, refreshed while the step runs, finalized when it settles.
